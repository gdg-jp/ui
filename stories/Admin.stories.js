...
export function AdminDemo() {
  ...
  const navigation = _jsx(UI.SidebarNav, {
    "aria-label": "\u30E1\u30A4\u30F3",
  ...
  return _jsxs(UI.AppShell, {
    brand: "GDG Apps",
    navigation: navigation,
    header: _jsxs(_Fragment, {
      children: [
        _jsx(UI.Text, {
          size: "sm",
          tone: "muted",
          children: "\u30C7\u30B6\u30A4\u30F3\u30B7\u30B9\u30C6\u30E0 / \u30B5\u30F3\u30D7\u30EB",
        }),
        _jsx(UI.ThemeToggle, {}),
        _jsx(UI.Avatar, {
          alt: "\u30B5\u30F3\u30D7\u30EB\u30E6\u30FC\u30B6\u30FC",
    ...
    children: [
                    ...
                    _jsxs(UI.Toolbar, {
                      children: [
                        _jsxs(UI.Text, {
                          size: "sm",
                          tone: "muted",
                          children: [deleted ? 0 : 1, " \u4EF6\u306E\u30A4\u30D9\u30F3\u30C8"],
                        }),
                        _jsx(UI.Pagination, { page: 1, pageCount: 1, onPageChange: () => {} }),
                      ],
                    }),
                  ],
                }),
      ...
      _jsx(UI.Dialog, {
        ...
        children: _jsxs(UI.DialogContent, {
          children: [
            _jsx(UI.DialogTitle, { children: "\u30A4\u30D9\u30F3\u30C8\u3092\u7DE8\u96C6" }),
